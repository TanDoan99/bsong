...
<link rel="icon" type="image/jpg" href="<%=request.getContextPath()%>/templates/public/images/logo-su-tu.jpg"/>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="<%=request.getContextPath()%>/index.jsp"><span>Trang chủ</span></a>
          <li class="active"><a href="<%=request.getContextPath()%>/contact"><span>Liên hệ</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
